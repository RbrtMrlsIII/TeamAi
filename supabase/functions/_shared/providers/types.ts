...
import type { ProviderTermination } from './termination.ts';

export interface GenerateResult { provider:string; model:string; requestId:string; text:string; usage:Usage; costUsd?:number; termination?:ProviderTermination; }
