...
function mapCommerceEvent(eventType: string): EventMapping | null {
  switch (eventType) {
    ...
    case "PAYMENT.CAPTURE.DENIED": return { type: "payment_denied", entitlementStatus: null, warning: "Payment was denied. TeamAi access was not granted." };
    case "PAYMENT.CAPTURE.PENDING": return { type: "payment_pending", entitlementStatus: null, warning: "Payment is pending. TeamAi access remains unavailable until payment completes." };
