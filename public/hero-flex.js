...
/** Issue #144 — hierarchy runtime R1–R5 (Steps 1–3). Presentation only. */
...
function setReducedMotion(next, {writeDocument = true} = {}){
  ...
  if (writeDocument) {
    try { document.documentElement.setAttribute('data-motion', reducedMotion ? 'reduced' : 'full'); } catch (_) {}
  }
  return reducedMotion;
}
function durations(){
