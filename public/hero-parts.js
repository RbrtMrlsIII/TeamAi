...
requestAnimationFrame(animateParts);
window.TeamAiHeroSpatial={getActivePart:()=>active?.dataset.part??null,setPart:(name)=>setPart(parts.find((part)=>part.dataset.part===name)??null),getMotionState:()=>reducedMotion?'reduced':'ambient'};
