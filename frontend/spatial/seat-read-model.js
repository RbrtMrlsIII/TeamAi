...
/**
 * @typedef {object} SeatReadModel
 * @property {string} seatId
 * @property {string} name
 * @property {string} role
 * @property {string} provider
 * @property {string} model
 * @property {'unknown'|'offline'|'degraded'|'healthy'} connectionHealth
 * @property {string} connectionLabel legacy/display connection string
 * @property {string} teamQuality
 * @property {string} toolQuality
 * @property {string} limits
 * @property {string} teamEntitlement
 * @property {string} providerEntitlement
 * @property {string} capability
 * @property {boolean} eligibleDisplay fixture/domain eligibility flag for UI only
 * @property {boolean} activationAllowedPresentation health + entitlement UI gate (not domain Activate)
 * @property {'fixture'|'domain'} source
 * @property {true} presentationOnly
 * @property {false} durable
 */
 ...
 * @returns {Record<string, SeatReadModel>}
 */
 ...
 * No-op if Hero stack is not loaded.
 * @param {SeatReadModel} projection
