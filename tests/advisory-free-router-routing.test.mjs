...
test('terminal slot outcomes do not fail sequence orchestration',()=>{const block=sequence.slice(sequence.indexOf('  openrouter_free:'),sequence.indexOf('  sequence_complete:'));assert.match(block,/continue-on-error:\s*true/);assert.match(sequence,/structured slot artifacts/i);});
