...
5. Record pass/fail and environment.
6. When deployed-web verification is required, target the named deployment URL and keep the deployed surface separate from source/authority claims.
7. Preserve report/trace output as verification evidence when useful.
...
## EVIDENCE
Playwright test result, target environment/URL, scenario name, and report/trace reference where applicable.
