...
F0–F7 field identity is not Product Law by itself. Promoting Status or Modal into legal boxes requires an explicit Product Law / reconciliation decision, not a skill edit alone.
...
7. Warn the user before proceeding when the requested change conflicts with an existing law or protected root, including the five legal boxes.
...
10. Apply V/A/E/A/M as appropriate.
...
- Replace Product Law with implementation details or F-numbers.
