...
**Note:** Full checklist skill-routing, Gate 5B/5C evidence detail, Pre-029 Planning Architecture, and product-experience vision sections remain as on `main` history prior to this spatial-frontier pointer update. Agents must not treat this recovery-index pointer change as deletion of prior endorsed backend scope.
