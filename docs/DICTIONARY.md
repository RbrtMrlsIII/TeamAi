...
**See also:** `docs/TEAMAI_3D_HERO_IMPLEMENTATION_ENTRY.md`, `docs/TEAMAI_3D_HERO_MACHINE_INTERACTION_CONTRACT.md`, `docs/TEAMAI_3D_HERO_MACHINE_CONSTRUCTION.md`, issues #83–#98
