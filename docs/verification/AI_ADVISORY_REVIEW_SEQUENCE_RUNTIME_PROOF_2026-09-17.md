...
**Runtime containment note:** this proof head is intentionally invalidated if the PR head changes during a sequence barrier, preventing later reviewer stages from running against stale proof evidence.
