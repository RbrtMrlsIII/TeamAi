...
**P1** + **P1.1** + **P2** + **P2.1** **merged** (#174–#176). **P3** SEAT_TOOLKIT runtime **this PR**. Next: **P3.1** visual flex (optional) or **P4**.
...
| **P3** | `SEAT_TOOLKIT` (optional) | Branch open motion; optional equip a11y + configure handoff | **This PR** (runtime) |
| **P3.1** | TOOLKIT visual flex | Frame tick + branchBoost + keyboard **T** | After P3 merge |
