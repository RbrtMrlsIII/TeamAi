...
**Spatial residual (#258):** [sync 2026-09-11T08:58Z] CAM-R-RETIRE + **ENT-T1** entrance web **gone** on machine; hero.css restored with V3.3 atmosphere markers; Layer A/B + chrome residual PR #259; Cam subject-lock still open. V3.5 COMPLETE — **no 029-released claim**.
...
BACKEND CLOCK
Backend contracts → identity → Firestore → Edge → commerce → provider → endorsement
```
...
| Slice family | Current state | What is true |
|---|---|---|
| V3.1–V3.5 | COMPLETE / MERGED | Entrance ladder closed on main |
| #258 residual | IN FLIGHT (PR #259) | ENT-T1 gone-not-blurred; CAM-R-RETIRE; ENT/CHR chrome |
| Cam-5–Cam-6 | IMPLEMENTED + residual | Seat look-at still open on some paths |
...
**Do not ask “what feature is next?” until this map can answer what is true, proven, stopped, and what evidence permits continuation.**
