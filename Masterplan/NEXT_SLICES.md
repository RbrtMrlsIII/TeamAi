...
The `Draft proof target` parser now recognizes the canonical PR-body heading levels without changing the substantive proof requirement. Validation remains exact-head and fail-closed.
