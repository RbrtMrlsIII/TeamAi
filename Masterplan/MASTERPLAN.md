...
- [x] #368 ordered advisory reviewer orchestration was merged into `main` with the explicit 1→2→2 cohort state machine, exact-head guards, durable sequence claim, and deterministic free model bindings.
