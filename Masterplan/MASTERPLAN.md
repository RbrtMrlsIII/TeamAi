...
- [x] The automatic advisory sequence is now five parallel OpenRouter Free Router slots with five distinct slot credentials, exact-head guards, one durable sequence claim per exact head, and actual routed model/provider evidence per successful slot.
