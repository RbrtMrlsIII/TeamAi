...
## Machine Hero replacement: PR #344

- [x] Candidate is isolated from the production Hero until promotion.
- [x] Parameterized machine graph and semantic modules exist on the candidate branch.
- [x] Geometry-driven subject/camera capabilities exist on the candidate branch.
